...
Project for Assignment 2 By (Ghiath(ga222kt) and Ghaith(gk222iw))
...
## Handing In
class called  `Main` is the class that runs the program then just follow the ui to continue.
# lending-staff-system-java-mvc
